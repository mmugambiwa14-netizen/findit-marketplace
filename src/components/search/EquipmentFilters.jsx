...
export default function EquipmentFilters({ category, make, condition, onUpdate }) {
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <SearchFilterSelect label="Equipment type" value={category} onChange={(value) => onUpdate('category', value)} options={MACHINERY_CATEGORIES} />
