...
export default function PropertyFilters({ category, categoryOptions = PROPERTY_CATEGORIES, bedrooms, onUpdate }) {
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <SearchFilterSelect label="Property type" value={category} onChange={(value) => onUpdate('category', value)} options={categoryOptions} />
