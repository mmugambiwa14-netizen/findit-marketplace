        ...
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-3 text-left leading-6">
            <span className="block">
              FindIt will open your device camera so you can record the video you chose to add. Your browser or operating system may ask for camera and microphone access.
            </span>
            <span className="flex items-start gap-2 rounded-xl border border-border bg-surface-secondary p-3 text-xs text-foreground">
              ...
              Recording stays on your device until you review it and explicitly upload it. FindIt does not start the camera in the background.
            </span>
