...
function GateLoading() {
  return <div className="relative mx-auto min-h-[70vh] max-w-xl px-4 pb-8 pt-20"><BackButton className="absolute left-4 top-4" fallback="/" label="Back to Discover" /><FormSkeleton fields={4} label="Checking publishing access" /></div>;
}
