...
-- processing event RETURNING column so it cannot conflict with the tour_id
-- output variable when a worker claims a job.
...
begin
  ...
  with candidates as (
    ...
    insert into public.listing_tour_events as e (
