-- 0036_v1_seller_tour_workflow.rollback.sql
-- Restore the Milestone 2 upload eligibility boundary. Use only after seller
-- upload controls are disabled; existing Tour rows and objects are preserved.
...
-- Restore the Milestone 2 completion expiry boundary.
