...
5 x `FINDIT_*_WORKER_SECRET`, `FINDIT_TOUR_PROCESSOR_MODE`, optional external
`TOUR_PROCESSOR_URL`, `TOUR_PROCESSOR_SECRET`, `TOUR_PROCESSING_CALLBACK_URL`, `TOUR_CACHE_PURGE_URL`,
