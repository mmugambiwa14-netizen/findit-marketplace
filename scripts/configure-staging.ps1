...
param(
  ...
  [string]$PagesOrigin = 'https://staging.peekalisting.com',
  [string]$PagesFallbackOrigin = 'https://staging.peekalisting.pages.dev',
...
supabase secrets set `
  ...
  "FINDIT_ALLOWED_ORIGINS=http://127.0.0.1:5173,http://localhost:5173,$PagesOrigin,$PagesFallbackOrigin" `
  "FINDIT_APP_URL=$PagesOrigin" |
  Out-Null
