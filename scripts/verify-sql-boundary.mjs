...
if (basename(migrationFiles.at(-1) ?? '') !== '0070_contextual_listing_status_type_safety.sql') {
  failures.push(`latest expected migration is 0070, found ${migrationFiles.at(-1) ?? 'none'}`);
}
