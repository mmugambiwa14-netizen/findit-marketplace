...
if (basename(migrationFiles.at(-1) ?? '') !== '0055_recommendation_projection_queue.sql') {
  failures.push(`latest expected migration is 0055, found ${migrationFiles.at(-1) ?? 'none'}`);
}
