...
if (basename(migrationFiles.at(-1) ?? '') !== '0046_mvp_foundation_countries_currency_publication.sql') {
  failures.push(`latest expected migration is 0046, found ${migrationFiles.at(-1) ?? 'none'}`);
}
