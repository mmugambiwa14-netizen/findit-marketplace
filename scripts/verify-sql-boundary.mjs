...
if (basename(migrationFiles.at(-1) ?? '') !== '0066_recommendation_service_named_arguments.sql') {
  failures.push(`latest expected migration is 0066, found ${migrationFiles.at(-1) ?? 'none'}`);
}
