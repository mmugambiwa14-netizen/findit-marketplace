...
if (basename(migrationFiles.at(-1) ?? '') !== '0094_private_recommended_service_event_implementation.sql') {
  failures.push(`latest expected migration is 0094, found ${migrationFiles.at(-1) ?? 'none'}`);
}
