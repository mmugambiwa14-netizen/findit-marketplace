...
if (basename(migrationFiles.at(-1) ?? '') !== '0068_contextual_ecosystem_completion.sql') {
  failures.push(`latest expected migration is 0068, found ${migrationFiles.at(-1) ?? 'none'}`);
}
