...
if (basename(migrationFiles.at(-1) ?? '') !== '0065_recommendation_certification_corrections.sql') {
  failures.push(`latest expected migration is 0065, found ${migrationFiles.at(-1) ?? 'none'}`);
}
