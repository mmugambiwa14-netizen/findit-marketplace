...
if (basename(migrationFiles.at(-1) ?? '') !== '0072_recommendation_aggregate_analytics.sql') {
  failures.push(`latest expected migration is 0072, found ${migrationFiles.at(-1) ?? 'none'}`);
}
