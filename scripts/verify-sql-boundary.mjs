...
if (basename(migrationFiles.at(-1) ?? '') !== '0081_public_business_profile_view_security.sql') {
  failures.push(`latest expected migration is 0081, found ${migrationFiles.at(-1) ?? 'none'}`);
}
