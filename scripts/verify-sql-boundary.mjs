...
if (basename(migrationFiles.at(-1) ?? '') !== '0071_privacy_preserving_personalization.sql') {
  failures.push(`latest expected migration is 0071, found ${migrationFiles.at(-1) ?? 'none'}`);
}
