...
if (basename(migrationFiles.at(-1) ?? '') !== '0086_rls_permissive_policy_consolidation.sql') {
  failures.push(`latest expected migration is 0086, found ${migrationFiles.at(-1) ?? 'none'}`);
}
