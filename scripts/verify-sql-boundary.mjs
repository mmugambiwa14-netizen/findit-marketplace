...
if (basename(migrationFiles.at(-1) ?? '') !== '0056_recommendation_partition_and_configuration_integrity.sql') {
  failures.push(`latest expected migration is 0056, found ${migrationFiles.at(-1) ?? 'none'}`);
}
