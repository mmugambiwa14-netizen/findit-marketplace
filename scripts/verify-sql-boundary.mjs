...
if (basename(migrationFiles.at(-1) ?? '') !== '0076_tour_cleanup_claim_output_disambiguation.sql') {
  failures.push(`latest expected migration is 0076, found ${migrationFiles.at(-1) ?? 'none'}`);
}
