...
if (basename(migrationFiles.at(-1) ?? '') !== '0049_listing_location_privacy_and_public_projection.sql') {
  failures.push(`latest expected migration is 0049, found ${migrationFiles.at(-1) ?? 'none'}`);
}
