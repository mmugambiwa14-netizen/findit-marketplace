...
if (basename(migrationFiles.at(-1) ?? '') !== '0057_recommendation_eligibility_geospatial_and_deletion_closure.sql') {
  failures.push(`latest expected migration is 0057, found ${migrationFiles.at(-1) ?? 'none'}`);
}
