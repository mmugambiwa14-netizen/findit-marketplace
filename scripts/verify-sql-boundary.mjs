...
if (basename(migrationFiles.at(-1) ?? '') !== '0080_listing_detail_related_services_context.sql') {
  failures.push(`latest expected migration is 0080, found ${migrationFiles.at(-1) ?? 'none'}`);
}
