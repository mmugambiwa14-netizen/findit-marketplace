...
if (basename(migrationFiles.at(-1) ?? '') !== '0075_tour_processing_claim_output_qualification.sql') {
  failures.push(`latest expected migration is 0075, found ${migrationFiles.at(-1) ?? 'none'}`);
}
