...
if (basename(migrationFiles.at(-1) ?? '') !== '0060_recommendation_global_service_isolation.sql') {
  failures.push(`latest expected migration is 0060, found ${migrationFiles.at(-1) ?? 'none'}`);
}
