...
if (basename(migrationFiles.at(-1) ?? '') !== '0082_pg_trgm_extension_schema_security.sql') {
  failures.push(`latest expected migration is 0082, found ${migrationFiles.at(-1) ?? 'none'}`);
}
