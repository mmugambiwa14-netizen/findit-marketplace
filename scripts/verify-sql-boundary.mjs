...
if (basename(migrationFiles.at(-1) ?? '') !== '0088_private_authorization_helper_implementations.sql') {
  failures.push(`latest expected migration is 0088, found ${migrationFiles.at(-1) ?? 'none'}`);
}
