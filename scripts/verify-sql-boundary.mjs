...
if (basename(migrationFiles.at(-1) ?? '') !== '0074_nearby_service_hosted_timeout_budget.sql') {
  failures.push(`latest expected migration is 0074, found ${migrationFiles.at(-1) ?? 'none'}`);
}
