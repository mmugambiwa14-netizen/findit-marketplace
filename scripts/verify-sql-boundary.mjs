...
if (basename(migrationFiles.at(-1) ?? '') !== '0045_v1_trigger_function_grant_closure.sql') {
  failures.push(`latest expected migration is 0045, found ${migrationFiles.at(-1) ?? 'none'}`);
}
