...
if (basename(migrationFiles.at(-1) ?? '') !== '0079_on_demand_recommendation_projection.sql') {
  failures.push(`latest expected migration is 0079, found ${migrationFiles.at(-1) ?? 'none'}`);
}
