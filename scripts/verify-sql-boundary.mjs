...
if (basename(migrationFiles.at(-1) ?? '') !== '0053_recommendation_foundation_hardening.sql') {
  failures.push(`latest expected migration is 0053, found ${migrationFiles.at(-1) ?? 'none'}`);
}
