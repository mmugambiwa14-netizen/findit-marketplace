...
if (basename(migrationFiles.at(-1) ?? '') !== '0061_recommendation_service_runtime_policy_and_cache.sql') {
  failures.push(`latest expected migration is 0061, found ${migrationFiles.at(-1) ?? 'none'}`);
}
