...
if (basename(migrationFiles.at(-1) ?? '') !== '0054_recommendation_foundation_certification_corrections.sql') {
  failures.push(`latest expected migration is 0054, found ${migrationFiles.at(-1) ?? 'none'}`);
}
