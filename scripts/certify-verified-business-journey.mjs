...
const stages = [
  { id: 'repository-contracts', args: ['--test', 'tests/verifiedBusinessJourneyContracts.test.mjs'], hosted: false },
  { id: 'hosted-business-profile-smoke', args: ['scripts/phase3-business-profiles-smoke-local.mjs'], hosted: true },
  { id: 'hosted-notification-smoke', args: ['scripts/phase3-notifications-smoke-local.mjs'], hosted: true },
];
...
const report = { journey: 'verified-business', generatedAt: new Date().toISOString(), hostedEnvironmentAvailable: hosted, status: 'running', stages: [] };
...
await writeFile('artifacts/certification/verified-business-journey.json', `${JSON.stringify(report, null, 2)}\n`);
